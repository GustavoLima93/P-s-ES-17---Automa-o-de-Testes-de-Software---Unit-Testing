...
public class TicketTest {
    ...
    public void testBuyTicketTitle(){
        ...
        String expect = "Ticket Magic Kingdom";
        MyTicket actual;
    ...
    public void testBuyTicketDescription(){
        ...
        String expect = "Melhor viagem do ano";
        MyTicket actual;
    ...
    public void testTicketDescription(){
        //arrange
        Ticket ticket = new Ticket();
        ticket.setDescription("Melhor viagem");

        String actual;
        String expected = "Melhor viagem";
    ...
    public void testTicketTitle(){
        //arrange
        Ticket ticket = new Ticket();
        ticket.setTitle("Melhor viagem teste");

        String actual;
        String expected = "Melhor viagem teste";
